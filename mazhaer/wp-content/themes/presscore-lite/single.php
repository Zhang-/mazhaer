    ...
    <div id="container">
        <div id="content" role="main">
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                <article id="<?php echo $post->ID?>" class="entry-common" itemtype="http://schema.org/Article" itemscope="itemscope" data-id="<?php echo $post->ID?>">
                    ...
                    <div id="crumb" itemprop="breadcrumb"><a rel="nofollow" href="<?php bloginfo('url');?>">首页</a>&nbsp;>&nbsp;<?php the_category(', ');?>&nbsp;>&nbsp;<?php the_title(); ?></div>
      ...
      <?php if(function_exists('the_views')) {the_views();} ?>
                    ...
                    <div class="entry-content" itemprop="description">
                        ...
                        <div class="post-like">
                             <a href="javascript:;" data-action="ding" data-id="<?php the_ID(); ?>" class="favorite<?php if(isset($_COOKIE['bigfa_ding_'.$post->ID])) echo ' done';?>">喜欢 
                                <span class="count">
